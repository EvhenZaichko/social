    ...
    return (
        <div className="flex justify-center  h-70 w-100 bg-night-700/50 rounded-2xl ">
            <form className="flex flex-col items-center mt-15" onSubmit={handleSubmit}>
                <h1 className="font-bold mt text-xl">Change Your Username</h1>
                <input type="text"
                       autoFocus
                       maxLength={20}
                ...
                <button
                    ...
                    className={`mt-10  w-30 py-3  rounded-2xl cursor-pointer transition-colors duration-300 ${available ? 'bg-white text-black hover:scale-101 hover:bg-green-300 ' : 'bg-gray-600 text-white'}`}
